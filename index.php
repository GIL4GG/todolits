...
<head>
   ...
   body {
    ...
    text-transform: uppercase;
        ...
        .badge-normal { background-color: rgb(0, 174, 255); ; color: white; }
        .btn {
            border-radius: 5px;
            font-weight: bold;
        }
        .btn-primary { background-color: rgb(0, 174, 255);  }
        .btn-danger { background-color: #dc3545; }
        .btn-warning { background-color: #ffc107; }
        .btn-success { background-color: rgb(0, 174, 255);  }
        .btn-sm {
            padding: 5px 10px;
        }
        .form-control {
        ...
        .subtask {
          ...
          border-left: 4px solid rgb(0, 174, 255); ; /* Menambahkan garis kiri untuk menandakan subtugas */
            }
        .subtask-item {
         display: flex;
        align-items: center;
...
<div class="row g-3 mb-4 statistik-sekolah">
    ...
    <div class="col-md-4">
        ...
        <select id="sort" class="form-select" onchange="location = this.value;">
            <option value="index.php?sort_by=">Pilih</option>
            <option value="index.php?sort_by=completed">Selesai</option>
            <option value="index.php?sort_by=deadline">Tenggat Waktu</option>
            <option value="index.php?sort_by=priority">Prioritas</option> 
        </select>
